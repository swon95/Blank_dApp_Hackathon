        ...
        <>
            <div className="container-profile fixed top-0 w-full">
                <div className="w-full h-[88px] relative bg-primaryColor">
                    <div className="w-[72px] h-[72px] bg-[#d9d9d9] absolute -bottom-[30px] left-[20px] rounded-full"></div>
                </div>
                <div className="profile shadow-md pb-4">
                    ...
                    <div className="profile px-2 mb-2">
                        ...
                        <div className="dashboard mb-2">
                            <span className="mr-2 text-dashboardGray">
                                12 following
                            </span>
                            <span className="mr-2 text-dashboardGray">
                                23 followers
                        ...
                        <div className="bio">
                            <p className="text-xs">
                                Hi, I am from korea I like Blockchain and I am
                                INTP
                            </p>
                        </div>
                    </div>
            ...
            <div className="px-4 py-4 mt-[250px]">
                ...
                <div className="tabvar">
                    <div className="tab-list py-4">
                        <button className="font-semibold p-2 border-b-4">
                            Feed
                        </button>
                        <button className="font-semibold p-2 text-dashboardGray">
                            History
                        </button>
                    </div>
                    <div className="contents-list">
                        <div className="feed flex">
                            <div className="feed-profile-image mr-3">
                                <div className="image-wrapper w-[48px] h-[48px] rounded-full bg-profileGray"></div>
                            </div>
                            <div className="feed-right flex flex-col">
                                <div className="feed-header flex">
                                    ...
                                    <p className="time text-dashboardGray pt-1">
                                        2d
                                    </p>
                                </div>
                                <div className="feed-body py-2">
                                    <p>
                                        아니 이 테스트 개웃김 ㄹㅇ 일러스트도
                                        겁나 귀엽고 내스타일임 그리고 poap
                                        주는데 뭔가 뿌듯해짐 나도 핫걸 된 기분?
                                    </p>
                                </div>
                                <div className="feed-originfeed py-4 px-4 border border-profileGray rounded-2xl">
                                    ...
                                    <div className="feed-body mt-4">
                                        ...
                                        <button className="w-full h-[60px] bg-primaryColor rounded-2xl">
                                            Let's do the test!
                                        </button>
                                    </div>
                                </div>
