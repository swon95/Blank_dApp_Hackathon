        ...
        <div className="feed flex">
            ...
            <div className="feed-right flex flex-col">
                ...
                <div className="feed-body py-2">
                    <p>
                        아니 이 테스트 개웃김 ㄹㅇ 일러스트도 겁나 귀엽고
                        내스타일임 그리고 poap 주는데 뭔가 뿌듯해짐 나도 핫걸 된
                        기분?
                    </p>
                </div>
                <div className="feed-originfeed py-4 px-4 border border-profileGray rounded-2xl">
                    ...
                    <div className="feed-body mt-4">
                        ...
                        <p className="mb-2">
                            당신의 핫걸 척도를 알아보세요. 이거 진짜 핫걸들은 다
                            티가 난다던데?
                        </p>
                        <button className="w-full h-[60px] bg-primaryColor rounded-2xl mb-2">
                            Let's do the test!
                        </button>
                        <img
                            className="w-full"
                            src={`${process.env.PUBLIC_URL}/${process.env.REACT_APP_IMAGE_PATH}`}
                        />
                    </div>
                </div>
            </div>
