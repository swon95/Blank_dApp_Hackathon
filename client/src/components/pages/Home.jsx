...
import ImgSlide2 from "../common/ImgSlide2";
...
function Home() {
  return (
    <>
      ...
      <div className="body w-[390] h-[1900]">
          ...
          <div className="bg-gray h-36 mx-4" style={{ width: "22.3rem" }}>
            ...
            <div className="flex">
              ...
              <div className="text-left ml-2 w-60 overflow-hidden overflow-ellipsis max-h-24">
                This test is insane!!<br></br> You guys should really try. I got
                ‘Lazy Rabbit’ and the NFT is so cute so it blah blah blah blah
